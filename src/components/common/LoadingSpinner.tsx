      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 border border-gray-100 dark:border-gray-700">
        ...
        <div className="flex justify-center mb-6">
          <div className="relative">
            ...
            ></div>
            <div
              className={`${sizeClasses[size]} rounded-full border-4 border-transparent border-t-blue-500 border-r-blue-500 animate-spin absolute top-0 left-0`}
            ></div>
            <div
              className={`${sizeClasses[size]} rounded-full border-4 border-transparent border-b-blue-300 border-l-blue-300 animate-spin absolute top-0 left-0`}
              style={{
        ...
        {/* Title */}
        <h2
          className={`text-center font-semibold text-gray-900 dark:text-white mb-2 ${textSizeClasses[size]}`}
        >
          {text}
        </h2>
        ...
        {/* Subtitle */}
        <p
          className={`text-center text-gray-600 dark:text-gray-400 mb-6 ${subtitleSizeClasses[size]}`}
        >
          {subtitle}
        </p>
